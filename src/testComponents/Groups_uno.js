...
import {deleteGroup} from "../../services/Groups_uno";
        ...
        return (
            <Accordion expanded={expanded === value.host.name_host} onChange={handleChange(value.host.name_host)}>
                ...
                <AccordionDetails>
                    ...
                    <IconButton aria-label="edit-machine-group"
                                onClick={() => {
                                    navigate(`/host/${value.host.id}/group/${value.host.group}`)
                                }}>
                        <EditIcon/>
                    </IconButton>
                    <IconButton aria-label="delete-machine-group"
